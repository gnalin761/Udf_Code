           ...
           SQL_TEXT error_message[257])
{
    ...
    if (numAnytypeParams >= 2 &&
        ...
        (inputInfo[0].datatype == VARCHAR_DT || inputInfo[0].datatype == CHAR_DT))
    {
        ...
        else if (inputInfo[1].paramIndex == -1 && inputInfo[1].datatype == SMALLINT_DT)
        {
            *(SMALLINT *)result = (SMALLINT)returnValue;
        }
        else if (inputInfo[1].paramIndex == -1 && inputInfo[1].datatype == INTEGER_DT)
        {
